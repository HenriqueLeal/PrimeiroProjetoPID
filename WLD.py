...
if descriptorgen:
    ...
    for i in mslice[1:imgn]:
        ...
        histogenerate(1, 
		              mslice[:]).lvalue = calc(subimage1)
        histogenerate(2, 
		              mslice[:]).lvalue = calc(subimage2)
        histogenerate(3, 
		              mslice[:]).lvalue = calc(subimage3)
        histogenerate(4, 
		              mslice[:]).lvalue = calc(subimage4)
        histogenerate(5, 
		              mslice[:]).lvalue = calc(subimage5)
        histogenerate(6, 
		              mslice[:]).lvalue = calc(subimage6)
        histogenerate(7, 
		              mslice[:]).lvalue = calc(subimage7)
        histogenerate(8, 
		              mslice[:]).lvalue = calc(subimage8)
